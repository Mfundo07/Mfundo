...
public class EnglishActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final Button englishNextButton = (Button) findViewById(R.id.button_next_english);
        final Button question1option1 = (Button) findViewById(R.id.english_question1_option1);
        final Button question1option2 = (Button) findViewById(R.id.english_question1_option2);
        final Button question1option3 = (Button) findViewById(R.id.english_question1_option3);
        final Button question1option4 = (Button) findViewById(R.id.english_question1_option4);
        final Button question2option1 = (Button) findViewById(R.id.english_question2_option1);
        final Button question2option2 = (Button) findViewById(R.id.english_question2_option2);
        final Button question2option3 = (Button) findViewById(R.id.english_question2_option3);
        final Button question2option4 = (Button) findViewById(R.id.english_question2_option4);
        final Button question3option1 = (Button) findViewById(R.id.english_question3_option1);
        final Button question3option2 = (Button) findViewById(R.id.english_question3_option2);
        final Button question3option3 = (Button) findViewById(R.id.english_question3_option3);
        final Button question3option4 = (Button) findViewById(R.id.english_question3_option4);
        final Button question4option1 = (Button) findViewById(R.id.english_question4_option1);
        final Button question4option2 = (Button) findViewById(R.id.english_question4_option2);
        final Button question4option3 = (Button) findViewById(R.id.english_question4_option3);
        final Button question4option4 = (Button) findViewById(R.id.english_question4_option4);
        final Button question5option1 = (Button) findViewById(R.id.english_question5_option1);
        final Button question5option2 = (Button) findViewById(R.id.english_question5_option2);
        final Button question5option3 = (Button) findViewById(R.id.english_question5_option3);
        final Button question5option4 = (Button) findViewById(R.id.english_question5_option4);





        englishNextButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                ViewFlipper vf = (ViewFlipper) findViewById(R.id.english_view_flipper);
        ...
        question5option1.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                englishNextButton.setVisibility(View.GONE);
    ...
    public void returnScore(double Score){
        ...
        // set title
        alertDialogBuilder.setTitle("English Quiz!");
